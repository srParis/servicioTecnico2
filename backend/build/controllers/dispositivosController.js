...
class DispositivosController {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.default.query('INSERT INTO dispositivos SET ?', [req.body]);
            res.json({ 'message': 'Se ha creado el dispositivo' });
        });
    }
    read(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const dispositivos = yield database_1.default.query('SELECT * FROM dispositivos', [req.body]);
